            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        ...
                        <!-- /.col -->
                        <div class="card text-bg-info mb-3" style="width: 18rem;margin-right:10px;margin-top:10px;">
                            <div class="card-header">عدد السور المحفوظة</div>
                            <div class="card-body">
                              <h5 class="card-title">  {{ $surahs }}  سورة</h5>
                              {{-- <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p> --}}
                            </div>
                          </div>

                          <div class="card text-bg-info mb-3" style="width: 18rem;margin-top:10px;margin-right:10px; ">
                            <div class="card-header">عدد الايات المحفوظة</div>
                            <div class="card-body">
                              <h5 class="card-title"> {{ $listeners }} آيات</h5>
                              {{-- <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p> --}}
                            </div>
                          </div>
