        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">تعديل الاية</h1>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
                                            ...
                                            <div class="col-20 grid-margin stretch-card">
                                                ...
                                                <div class="card" >
                                                    <div class="card-body">
                                                        ...
                                                        <form action="{{ route('listener.update',$listener->id) }}" method="Post" class="forms-sample" enctype="multipart/form-data">
                                                            @method('patch')
                                                                @csrf
                                                                <div class="form-group">
                                                                    <label for="exampleInputName1">* اضافة الآيه باللغة العربية</label>
                                                                    <input name="arabic" type="text" class="form-control"  id="exampleInputName1" value="{{ $listener->text_arabic }}"  required>
                                                                </div>
                                                                
                                                                <div class="form-group">
                                                                    <label for="exampleInputName1">* اضافة الآيه باللغة الانجليزية</label>
                                                                    <input name="english" type="text" class="form-control"  id="exampleInputName1" value="{{ $listener->text_english }}" required>
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="surah" class="form-select form-select-sm form-control" aria-label=".form-select-sm example">
                                                                        {{-- <option selected>{{ $surahs->surah_name }}</option> --}}
                                                                        @foreach ($surahs as $surah)
                                                                        <option required>{{ $surah->surah_name }}</option>
                                                                        @endforeach
